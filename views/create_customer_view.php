...
>
        ...
        <div class="mb-3">
            <label for="customer_contact_last_name" class="form-label">
              Customer Contact Last Name <span class="text-danger">(Required)</span>
            </label>
        ...
        <div class="mb-3">
            <label for="customer_email" class="form-label">
              Customer Email Address <span class="text-danger">(Required)</span>
            </label>
            <input type="email" class="form-control" id="customer_email" name="customer_email" required>
        </div>

        <div class="mb-3">
            <label for="customer_contact_address" class="form-label">
              Customer Contact Address <span class="text-danger">(Required)</span>
            </label>
            <input type="text" class="form-control" id="customer_contact_address" name="customer_contact_address" required>
        </div>

        <div class="mb-3">
            <label for="customer_contact_city" class="form-label">
              Customer Contact City <span class="text-danger">(Required)</span>
            </label>
            <input type="text" class="form-control" id="customer_contact_city" name="customer_contact_city" required>
        </div>

        <div class="mb-3">
            <label for="customer_contact_state_or_province" class="form-label">
              Customer Contact State or Province <span class="text-danger">(Required)</span>
            </label>
        ...
        <div class="mb-3">
            <label for="customer_contact_zip_or_postal_code" class="form-label">
              Customer Contact Zip or Postal Code <span class="text-danger">(Required)</span>
            </label>
        ...
        <div class="mb-3">
            <label for="customer_contact_country" class="form-label">
              Customer Contact Country <span class="text-danger">(Required)</span>
            </label>
        ...
        <div class="mb-3">
            <label for="customer_phone" class="form-label">
              Customer Contact Phone Number <span class="text-danger">(Required)</span>
            </label>
